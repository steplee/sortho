...
class Blender1:
    ...
    def _blend_tiles(self, tfd, framed, tryShowAll=True):
        ...
        for tileCoord, frameKeys in tfd.items():
            ...
            img = self.blender(imgs, weights)[pad:-pad, pad:-pad]
            if tryShowAll:
                print(tileCoord, minx,miny)
...
if __name__ == '__main__':
    ...
    if 1:
        ...
        confs = [OmegaConf.create(dict(
            input=dict(path='/data/inertialLabs/flightFeb15/irnOutput/1707947224/eval.bin', frameStride=8, maxFrames=16),
